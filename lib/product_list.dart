...
import 'package:shopping_cart_tutorials/cart_provider.dart';
import 'package:shopping_cart_tutorials/cart_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
     appBar: AppBar(
      ...
      body:Column(
        children: [
          Expanded(child: ListView.builder(itemCount:productName.length,itemBuilder: (context,index){
            return Card(
              child: Padding(
